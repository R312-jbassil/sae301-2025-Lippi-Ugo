...
export type LunetteRecord = {
	code_svg?: HTMLString
	couleur_branche?: RecordIdString
	couleur_monture?: RecordIdString
	created: IsoAutoDateString
	id: string
	largeur_pont?: number
	nom?: string
...
export enum MateriauxTypeOptions {
	"branches" = "branches",
	"monture" = "monture",
	"verre" = "verre",
}
...
export type CouleurResponse<Texpand = unknown> = Required<CouleurRecord> & BaseSystemFields<Texpand>
